...
class VTADevice {
 public:
  VTADevice() {
    ...
    vta_alu_handle_ = VTAMapRegister(VTA_ALU_ADDR);
  ...
  ~VTADevice() {
    ...
    VTAUnmapRegister(vta_alu_handle_);
  ...
  int Run(vta_phy_addr_t insn_phy_addr,
    ...
    VTAWriteMappedReg(vta_alu_handle_, 0x0, VTA_AUTORESTART);
